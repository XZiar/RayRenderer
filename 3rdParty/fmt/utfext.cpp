...
{
    return CharsetConvertor<UTF7, UTF16LE, char, char16_t>::Convert(str, size);
}
template<>
std::basic_string<char16_t> internal::UTFFormatterSupport::ConvertU8Str(const char* str, const size_t size)
{
...
{
    return CharsetConvertor<UTF7, UTF32LE, char, char32_t>::Convert(str, size);
}
template<>
std::basic_string<char32_t> internal::UTFFormatterSupport::ConvertU8Str(const char* str, const size_t size)
{
