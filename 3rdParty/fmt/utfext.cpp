...
{
    return format_float_<common::str::detail::UTF16LE>(buffer, size, format, precision, value);
}
...
{
    return format_float_<common::str::detail::UTF32LE>(buffer, size, format, precision, value);
}
