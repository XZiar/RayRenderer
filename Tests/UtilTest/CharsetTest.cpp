...
static void TestStrConv()
{
    ...
    const auto ret = str::charset::to_u16string(std::u32string(U"hh"), str::Charset::UTF32LE);
    std::u16string utf16(u"𤭢");
    std::string utf8 = str::charset::to_string(utf16, Charset::UTF8, Charset::UTF16LE);
    ...
    utf16 = str::charset::to_u16string(utf8, Charset::UTF8);
    log().debug(u"output u16: {}\n", utf16);

    utf8 = str::charset::to_string(utf16, Charset::UTF16BE, Charset::UTF16LE);
    ...
    utf16 = str::charset::to_u16string(u8raw, chtype);
    ...
    const auto myget = str::charset::to_string(utf16, Charset::GB18030, Charset::UTF16LE);
    file::WriteAll(basePath / u"utf8-sample-gb18030.html", myget);
    const auto myout = str::charset::to_u8string(myget, Charset::GB18030);
