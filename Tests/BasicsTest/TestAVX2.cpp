...
RegisterSIMDBaseTest(I32x8,  200, Move, SWE, SEL, Add, Sub, SatAdd, SatSub, MulLo,        MulX, Neg, Abs, Min, Max, SLL, SLLV, SRL, SRLV, SRA);
RegisterSIMDBaseTest(U32x8,  200, Move, SWE, SEL, Add, Sub, SatAdd, SatSub, MulLo,        MulX,      Abs, Min, Max, SLL, SLLV, SRL, SRLV, SRA);
RegisterSIMDBaseTest(I32x4,  200,      MSK, SLLV, SRLV);
RegisterSIMDBaseTest(U32x4,  200,      MSK, SLLV, SRLV);
RegisterSIMDBaseTest(I16x16, 200, Move, SWE, SEL, Add, Sub, SatAdd, SatSub, MulLo, MulHi, MulX, Neg, Abs, Min, Max, SLL, SLLV, SRL, SRLV, SRA);
RegisterSIMDBaseTest(U16x16, 200, Move, SWE, SEL, Add, Sub, SatAdd, SatSub, MulLo, MulHi, MulX,      Abs, Min, Max, SLL, SLLV, SRL, SRLV, SRA);
RegisterSIMDBaseTest(I16x8,  200,      MSK, SLLV, SRLV);
RegisterSIMDBaseTest(U16x8,  200,      MSK, SLLV, SRLV);
RegisterSIMDBaseTest(I8x32,  200, Move,      SEL, Add, Sub, SatAdd, SatSub, MulLo, MulHi, MulX, Neg, Abs, Min, Max, SLL,       SRL,       SRA);
RegisterSIMDBaseTest(U8x32,  200, Move,      SEL, Add, Sub, SatAdd, SatSub, MulLo, MulHi, MulX,      Abs, Min, Max, SLL,       SRL,       SRA);
...
RegisterSIMDZipOETest(200, F64x4, F32x8, I64x4, U64x4, I32x8, U32x8, I16x16, U16x16, I8x32, U8x32)
...
RegisterSIMDSelectRandTest(200, I16x16, I8x32)
