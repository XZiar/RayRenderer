...
RegisterSIMDBaseTest(F32x4, 30,      SEL, Add, Sub,                        Mul, Div, Neg, Abs, Min, Max);
...
RegisterSIMDBaseTest(I16x8, 30, SWE, SEL, Add, Sub, SatAdd, SatSub, MulLo, MulX,     Neg, Abs, Min, Max, SLL, SRL, SRA);
