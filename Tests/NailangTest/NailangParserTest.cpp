...
public:
    ...
    ~Replacer() override {}
    void OnReplaceVariable(std::u32string& output, void*, const std::u32string_view var) override
    {
        Vars.push_back(var);
        output.append(Target);
    }
    void OnReplaceFunction(std::u32string& output, void*, const std::u32string_view func, const common::span<const std::u32string_view> args) override
    {
