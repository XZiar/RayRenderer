...
DEFINE_FASTPATH_PARTIAL(CopyManager, A64)
{
    REGISTER_FASTPATH_VARIANTS(SwapRegion, SIMD128, LOOP);
    REGISTER_FASTPATH_VARIANTS(Reverse1, SIMD128, LOOP);
    REGISTER_FASTPATH_VARIANTS(Reverse2, SIMD128, LOOP);
    REGISTER_FASTPATH_VARIANTS(Reverse3, SIMD128, LOOP);
    REGISTER_FASTPATH_VARIANTS(Reverse4, SIMD128, LOOP);
    REGISTER_FASTPATH_VARIANTS(Reverse8, SIMD128, LOOP);
    ...
    REGISTER_FASTPATH_VARIANTS(TruncCopy21, NEON, SIMD128, LOOP);
    REGISTER_FASTPATH_VARIANTS(TruncCopy41, NEON, SIMD128, LOOP);
    REGISTER_FASTPATH_VARIANTS(TruncCopy42, NEON, SIMD128, LOOP);
    REGISTER_FASTPATH_VARIANTS(TruncCopy81, SIMD128, LOOP);
    REGISTER_FASTPATH_VARIANTS(TruncCopy82, NEON, SIMD128, LOOP);
    REGISTER_FASTPATH_VARIANTS(TruncCopy84, NEON, SIMD128, LOOP);
...
DEFINE_FASTPATH_PARTIAL(MiscIntrins, A64)
{
    ...
    REGISTER_FASTPATH_VARIANTS(PopCounts, SIMD128, COMPILER, NAIVE);
    REGISTER_FASTPATH_VARIANTS(Hex2Str, SIMD128, NAIVE);
    REGISTER_FASTPATH_VARIANTS(PauseCycles, COMPILER);
}

DEFINE_FASTPATH_PARTIAL(DigestFuncs, A64)
{
