...
DECLARE_FASTPATH_PARTIALS(MiscIntrins, AVX2, SSE42)
...
DECLARE_FASTPATH_PARTIALS(CopyManager, A64, A32)
DECLARE_FASTPATH_PARTIALS(MiscIntrins, A64, A32)
DECLARE_FASTPATH_PARTIALS(DigestFuncs, A64, A32)
#endif
