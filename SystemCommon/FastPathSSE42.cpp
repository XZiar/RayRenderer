...
DEFINE_FASTPATH_PARTIAL(CopyManager, SSE42)
{
    ...
    REGISTER_FASTPATH_VARIANTS(SExtCopy12, SSSE41, LOOP);
    REGISTER_FASTPATH_VARIANTS(SExtCopy14, SSSE41, LOOP);
    REGISTER_FASTPATH_VARIANTS(SExtCopy24, SSSE41, LOOP);
    REGISTER_FASTPATH_VARIANTS(SExtCopy28, SSSE41, LOOP);
    REGISTER_FASTPATH_VARIANTS(SExtCopy48, SSSE41, LOOP);
    ...
    REGISTER_FASTPATH_VARIANTS(CvtF16F32, SSSE41, LOOP);
    REGISTER_FASTPATH_VARIANTS(CvtF32F16, SSSE41, LOOP);
