...
DEFINE_FASTPATH_PARTIAL(CopyManager, SSE42)
{
    ...
    REGISTER_FASTPATH_VARIANTS(ZExtCopy14, SIMDSSSE3, LOOP);
    ...
    REGISTER_FASTPATH_VARIANTS(SExtCopy12, SIMDSSE41, LOOP);
    REGISTER_FASTPATH_VARIANTS(SExtCopy14, SIMDSSE41, LOOP);
    REGISTER_FASTPATH_VARIANTS(SExtCopy24, SIMDSSE41, LOOP);
    REGISTER_FASTPATH_VARIANTS(SExtCopy28, SIMDSSE41, LOOP);
    REGISTER_FASTPATH_VARIANTS(SExtCopy48, SIMDSSE41, LOOP);
    REGISTER_FASTPATH_VARIANTS(TruncCopy21, SIMDSSSE3, LOOP);
    REGISTER_FASTPATH_VARIANTS(TruncCopy41, SIMDSSSE3, LOOP);
    REGISTER_FASTPATH_VARIANTS(TruncCopy42, SIMDSSSE3, LOOP);
    REGISTER_FASTPATH_VARIANTS(TruncCopy81, SIMDSSSE3, LOOP);
    REGISTER_FASTPATH_VARIANTS(TruncCopy82, SIMDSSSE3, LOOP);
    REGISTER_FASTPATH_VARIANTS(TruncCopy84, SIMDSSSE3, LOOP);
    ...
    REGISTER_FASTPATH_VARIANTS(CvtF32F16, SIMDSSE41, LOOP);
