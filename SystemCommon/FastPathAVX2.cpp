...
{
    REGISTER_FASTPATH_VARIANTS(SwapRegion, AVX, SIMD128, LOOP);
    REGISTER_FASTPATH_VARIANTS(Reverse1, AVX2, SSSE3, LOOP);
    REGISTER_FASTPATH_VARIANTS(Reverse2, AVX2, SSSE3, LOOP);
    REGISTER_FASTPATH_VARIANTS(Reverse4, AVX2, SSSE3, LOOP);
    REGISTER_FASTPATH_VARIANTS(Reverse8, AVX2, SSSE3, LOOP);
