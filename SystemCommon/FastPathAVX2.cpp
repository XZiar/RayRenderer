...
DEFINE_FASTPATH_PARTIAL(CopyManager, AVX2)
{
    ...
    REGISTER_FASTPATH_VARIANTS(SExtCopy12, AVX2, SSSE41, LOOP);
    REGISTER_FASTPATH_VARIANTS(SExtCopy14, AVX2, SSSE41, LOOP);
    REGISTER_FASTPATH_VARIANTS(SExtCopy24, AVX2, SSSE41, LOOP);
    REGISTER_FASTPATH_VARIANTS(SExtCopy28, AVX2, SSSE41, LOOP);
    REGISTER_FASTPATH_VARIANTS(SExtCopy48, AVX2, SSSE41, LOOP);
