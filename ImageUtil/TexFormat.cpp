    ...
    case TextureFormat::DTYPE_CAT_COMP:
        {
            ...
            return common::str::Formatter<char>{}.FormatStatic(FmtString("COMPOSITE [{:^7}{:3}] channel[{:^7}] {}"sv),
                dtype, rev, channel, srgb);
        }
    case TextureFormat::DTYPE_CAT_COMPRESS:
        {
            ...
            const auto channel = GetChannelSV(format & TextureFormat::MASK_CHANNEL_RAW);
            return common::str::Formatter<char>{}.FormatStatic(FmtString("COMPRESS [{:^7}] channel[{:^7}] {}"sv),
                dtype, channel, srgb);
        }
    case TextureFormat::DTYPE_CAT_PLAIN:
        {
            ...
            return common::str::Formatter<char>{}.FormatStatic(FmtString("PLAIN [{:^7}({:7})] channel[{:^7}] {}"sv),
                dtype, dflag, channel, srgb);
        }
    default:
        return "ERROR";
    }
