...
DEFINE_FASTPATH_PARTIAL(YCCConvertor, A32)
{
    ...
    REGISTER_FASTPATH_VARIANTS(RGB8ToYCbCr8,        NEON_F32, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToYCbCr8Fast,   NEON_F32, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToYCbCr8,       NEON_F32, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(RGB8ToAYUV8Fast,     NEON_F32, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(RGB8ToAYUV8,         NEON_F32, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToAYUV8Fast,    NEON_F32, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToAYUV8,        NEON_F32, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(YCbCr8ToRGB8,        NEON_F32, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(YCbCr8ToRGBA8,       NEON_F32, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(RGB8ToYCbCr8PlanarFast,  NEON_F32, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(RGB8ToYCbCr8Planar,      NEON_F32, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToYCbCr8PlanarFast, NEON_F32, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToYCbCr8Planar,     NEON_F32, LOOP_I16);
}
