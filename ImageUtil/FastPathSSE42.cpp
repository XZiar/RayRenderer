...
DEFINE_FASTPATH_PARTIAL(ColorConvertor, SSE42)
{
    ...
    REGISTER_FASTPATH_VARIANTS(RGB565ToRGB8,    SSE41, LOOP);
    REGISTER_FASTPATH_VARIANTS(BGR565ToRGB8,    SSE41, LOOP);
