...
DEFINE_FASTPATH_PARTIAL(YCCConvertor, SSE42)
{
    ...
    REGISTER_FASTPATH_VARIANTS(RGB8ToYCbCr8,        SSE41_I16_2, SSE41_I16, SSE41_F32, LOOP_I16, LOOP_F32);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToYCbCr8Fast,   SSE41_I8, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToYCbCr8,       SSE41_I16_2, SSE41_I16, SSE41_F32, LOOP_I16, LOOP_F32);
    REGISTER_FASTPATH_VARIANTS(YCbCr8ToRGB8,        SSE41_I16_2, SSE41_I16, SSE41_F32, LOOP_I16, LOOP_F32);
    REGISTER_FASTPATH_VARIANTS(RGB8ToYCbCr8Planar,  SSE41_I16_2, SSE41_I16, SSE41_F32, LOOP_I16, LOOP_F32);
}
