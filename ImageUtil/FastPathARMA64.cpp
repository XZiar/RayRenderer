...
DEFINE_FASTPATH_PARTIAL(ColorConvertor, A64)
{
    ...
    REGISTER_FASTPATH_VARIANTS(GfToRGBAf,       NEONA64, SIMD128, NEON, LOOP);
    REGISTER_FASTPATH_VARIANTS(GAfToRGBf,       SIMD128, NEON, LOOP);
    REGISTER_FASTPATH_VARIANTS(GAfToRGBAf,      NEONA64, SIMD128, NEON, LOOP);
    ...
    REGISTER_FASTPATH_VARIANTS(RGB555ToRGB8,    NEON2, LOOP); // NEON_LUT is always faster: NEONA64, NEON, 
    REGISTER_FASTPATH_VARIANTS(BGR555ToRGB8,    NEON2, LOOP); // NEON_LUT is always faster: NEONA64, NEON, 
    REGISTER_FASTPATH_VARIANTS(RGB555ToRGBA8,   NEON2, LOOP); // NEON_LUT is always faster: NEON, SIMD128, 
    REGISTER_FASTPATH_VARIANTS(BGR555ToRGBA8,   NEON2, LOOP); // NEON_LUT is always faster: NEON, SIMD128, 
    REGISTER_FASTPATH_VARIANTS(RGB5551ToRGBA8,  NEON2, LOOP); // NEON_LUT is always faster: NEON, SIMD128, 
    REGISTER_FASTPATH_VARIANTS(BGR5551ToRGBA8,  NEON2, LOOP); // NEON_LUT is always faster: NEON, SIMD128, 

    REGISTER_FASTPATH_VARIANTS(RGB565ToRGB8,    NEON2, LOOP); // NEON_LUT is always faster: NEONA64, NEON, 
    REGISTER_FASTPATH_VARIANTS(BGR565ToRGB8,    NEON2, LOOP); // NEON_LUT is always faster: NEONA64, NEON, 
    REGISTER_FASTPATH_VARIANTS(RGB565ToRGBA8,   NEON2, LOOP); // NEON_LUT is always faster: NEON, SIMD128, 
    REGISTER_FASTPATH_VARIANTS(BGR565ToRGBA8,   NEON2, LOOP); // NEON_LUT is always faster: NEON, SIMD128, 
...
DEFINE_FASTPATH_PARTIAL(YCCConvertor, A64)
{
    // FP32 is slow and no benefits
    REGISTER_FASTPATH_VARIANTS(RGB8ToYCbCr8Fast,    NEON_I16, NEON_I8DP4A, NEON_U8DP4A, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(RGB8ToYCbCr8,        NEON_I16, NEON_F16, NEON_F32, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToYCbCr8Fast,   NEON_I16, NEON_I8DP4A, NEON_U8DP4A, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToYCbCr8,       NEON_I16, NEON_F16, NEON_F32, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(RGB8ToAYUV8Fast,     NEON_I16, NEON_I8DP4A, NEON_U8DP4A, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(RGB8ToAYUV8,         NEON_I16, NEON_F16, NEON_F32, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToAYUV8Fast,    NEON_I16, NEON_I8DP4A, NEON_U8DP4A, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToAYUV8,        NEON_I16, NEON_F16, NEON_F32, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(YCbCr8ToRGB8,        NEON_I16, NEON_F16, NEON_F32, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(YCbCr8ToRGBA8,       NEON_I16, NEON_F16, NEON_F32, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(RGB8ToYCbCr8PlanarFast,  NEON_I16, NEON_I8DP4A, NEON_U8DP4A, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(RGB8ToYCbCr8Planar,      NEON_I16, NEON_F16, NEON_F32, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToYCbCr8PlanarFast, NEON_I16, NEON_I8DP4A, NEON_U8DP4A, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToYCbCr8Planar,     NEON_I16, NEON_F16, NEON_F32, LOOP_I16);
}
