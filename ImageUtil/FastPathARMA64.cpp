...
DEFINE_FASTPATH_PARTIAL(YCCConvertor, A64)
{
    ...
    REGISTER_FASTPATH_VARIANTS(RGB8ToYCbCr8,        NEON_I16, NEON_F16, NEON_F32, LOOP_I16); // FP32 is slow and no benefits
    REGISTER_FASTPATH_VARIANTS(RGBA8ToYCbCr8Fast,   NEON_I16, NEON_I8DP4A, NEON_U8DP4A, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToYCbCr8,       NEON_I16, NEON_F16, NEON_F32, LOOP_I16); // FP32 is slow and no benefits
    REGISTER_FASTPATH_VARIANTS(YCbCr8ToRGB8,        NEON_I16, NEON_F16, NEON_F32, LOOP_I16); // FP32 is slow and no benefits
    REGISTER_FASTPATH_VARIANTS(RGB8ToYCbCr8PlanarFast,  NEON_I16, NEON_I8DP4A, NEON_U8DP4A, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(RGB8ToYCbCr8Planar,      NEON_I16, NEON_F16, NEON_F32, LOOP_I16); // FP32 is slow and no benefits
    REGISTER_FASTPATH_VARIANTS(RGBA8ToYCbCr8PlanarFast, NEON_I16, NEON_I8DP4A, NEON_U8DP4A, LOOP_I16);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToYCbCr8Planar,     NEON_I16, NEON_F16, NEON_F32, LOOP_I16); // FP32 is slow and no benefits
}
