...
DEFINE_FASTPATH_PARTIAL(ColorConvertor, AVX512)
{
    ...
    REGISTER_FASTPATH_VARIANTS(RGB555ToRGB8, AVX512BW);
    REGISTER_FASTPATH_VARIANTS(BGR555ToRGB8, AVX512BW);
    REGISTER_FASTPATH_VARIANTS(RGB565ToRGB8, AVX512BW);
    REGISTER_FASTPATH_VARIANTS(BGR565ToRGB8, AVX512BW);
}
