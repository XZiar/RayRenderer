...
DEFINE_FASTPATH_PARTIAL(ColorConvertor, AVX512)
{
    ...
    REGISTER_FASTPATH_VARIANTS(Extract8x3,  AVX512VBMI2, AVX512VBMI, AVX512BW,  AVX2);
    ...
    REGISTER_FASTPATH_VARIANTS(Combine8x3,  AVX512VBMI, AVX512BW, AVX2);
...
{
    REGISTER_FASTPATH_VARIANTS(RGB8ToYCbCr8Fast,    AVX512VBMI_I8, AVX512VNNI_I8, AVX512_I8); // I8DP4A has too many shuffle usage
    REGISTER_FASTPATH_VARIANTS(RGB8ToYCbCr8,        AVX512VNNI_I16, AVX512VBMI_I16);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToYCbCr8Fast,   AVX512VBMI_I8, AVX512VNNI_I8, AVX512_I8); // I8DP4A has too many shuffle usage
    REGISTER_FASTPATH_VARIANTS(RGBA8ToYCbCr8,       AVX512VNNI_I16, AVX512VBMI_I16, AVX512_I16);

    REGISTER_FASTPATH_VARIANTS(RGB8ToAYUV8Fast,     AVX512VBMI_I8, AVX512VNNI_I8, AVX512_I8); // I8DP4A has too many shuffle usage
    REGISTER_FASTPATH_VARIANTS(RGB8ToAYUV8,         AVX512VNNI_I16, AVX512VBMI_I16);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToAYUV8Fast,    AVX512VBMI_I8, AVX512VNNI_I8, AVX512_I8); // I8DP4A has too many shuffle usage
    REGISTER_FASTPATH_VARIANTS(RGBA8ToAYUV8,        AVX512VNNI_I16, AVX512VBMI_I16, AVX512_I16);

    REGISTER_FASTPATH_VARIANTS(RGB8ToY410,          AVX512VNNI_I16, AVX512VBMI_I16);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToY410,         AVX512VNNI_I16, AVX512VBMI_I16, AVX512_I16);

    REGISTER_FASTPATH_VARIANTS(YCbCr8ToRGB8,        AVX512VBMI_I16_2, AVX512VBMI_I16, AVX512_I16_2, AVX512_I16);
    REGISTER_FASTPATH_VARIANTS(YCbCr8ToRGBA8,       AVX512VBMI_I16_2, AVX512VBMI_I16, AVX512_I16_2, AVX512_I16);

    REGISTER_FASTPATH_VARIANTS(RGB8ToYCbCr8PlanarFast,    AVX512VBMI_I8, AVX512VNNI_I8, AVX512_I8); // I8DP4A has too many shuffle usage
    REGISTER_FASTPATH_VARIANTS(RGB8ToYCbCr8Planar,        AVX512VBMI_I16);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToYCbCr8PlanarFast,   AVX512VBMI_I8, AVX512VNNI_I8, AVX512_I8); // I8DP4A has too many shuffle usage
    REGISTER_FASTPATH_VARIANTS(RGBA8ToYCbCr8Planar,       AVX512VBMI_I16, AVX512_I16);
}
