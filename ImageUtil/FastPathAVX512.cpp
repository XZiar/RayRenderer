...
{
    REGISTER_FASTPATH_VARIANTS(RGB8ToYCbCr8, AVX512VBMI_I8, AVX512VBMI_I8DP4A, AVX512VBMI_I16, AVX512_I8); // I8DP4A has too many shuffle usage
    REGISTER_FASTPATH_VARIANTS(YCbCr8ToRGB8, AVX512VBMI_I16, AVX512_I16);
}
