...
DEFINE_FASTPATH_PARTIAL(ColorConvertor, AVX512)
{
    ...
    REGISTER_FASTPATH_VARIANTS(Combine8x2,  AVX512BW, AVX2);
    REGISTER_FASTPATH_VARIANTS(Combine8x3,  AVX512VBMI, AVX2);
    REGISTER_FASTPATH_VARIANTS(Combine8x4,  AVX512BW, AVX2);
    REGISTER_FASTPATH_VARIANTS(Combine32x2, AVX512BW, AVX2);
    REGISTER_FASTPATH_VARIANTS(Combine32x3, AVX512BW, AVX2);
    REGISTER_FASTPATH_VARIANTS(Combine32x4, AVX512BW, AVX2);
    REGISTER_FASTPATH_VARIANTS(RGB555ToRGB8,   AVX512VBMI, AVX512BW);
    REGISTER_FASTPATH_VARIANTS(BGR555ToRGB8,   AVX512VBMI, AVX512BW);
    REGISTER_FASTPATH_VARIANTS(RGB555ToRGBA8,  AVX512BW);
    REGISTER_FASTPATH_VARIANTS(BGR555ToRGBA8,  AVX512BW);
    REGISTER_FASTPATH_VARIANTS(RGB5551ToRGBA8, AVX512BW);
    REGISTER_FASTPATH_VARIANTS(BGR5551ToRGBA8, AVX512BW);
    REGISTER_FASTPATH_VARIANTS(RGB565ToRGB8,   AVX512VBMI, AVX512BW);
    REGISTER_FASTPATH_VARIANTS(BGR565ToRGB8,   AVX512VBMI, AVX512BW);
    REGISTER_FASTPATH_VARIANTS(RGB565ToRGBA8,  AVX512BW);
    REGISTER_FASTPATH_VARIANTS(BGR565ToRGBA8,  AVX512BW);
