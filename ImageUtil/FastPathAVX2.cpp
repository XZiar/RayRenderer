...
DEFINE_FASTPATH_PARTIAL(ColorConvertor, AVX2)
{
    ...
    REGISTER_FASTPATH_VARIANTS(RGB555ToRGB8,    SIMD128, BMI2);
    REGISTER_FASTPATH_VARIANTS(BGR555ToRGB8,    SIMD128);
    ...
    REGISTER_FASTPATH_VARIANTS(RGB565ToRGB8,    SIMD128);
    REGISTER_FASTPATH_VARIANTS(BGR565ToRGB8,    SIMD128);
