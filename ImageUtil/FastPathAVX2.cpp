...
DEFINE_FASTPATH_PARTIAL(ColorConvertor, AVX2)
{
    ...
    REGISTER_FASTPATH_VARIANTS(GA8ToRGBA8,  AVX2, BMI2);
    REGISTER_FASTPATH_VARIANTS(RGB8ToRGBA8, BMI2);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToRGB8, BMI2);
    // REGISTER_FASTPATH_VARIANTS(RGB8ToRGBA8, AVX2);
    // REGISTER_FASTPATH_VARIANTS(RGBA8ToRGB8, AVX2);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToR8,   AVX2, BMI2);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToG8,   AVX2, BMI2);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToB8,   AVX2, BMI2);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToA8,   AVX2, BMI2);
