...
DEFINE_FASTPATH_PARTIAL(YCCConvertor, AVX2)
{
    ...
    REGISTER_FASTPATH_VARIANTS(RGB8ToAYUV8Fast,     AVX2VNNI_I8, AVX2_I8);
    REGISTER_FASTPATH_VARIANTS(RGB8ToAYUV8,         AVX2VNNI_I16, AVX2_I16);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToAYUV8Fast,    AVX2VNNI_I8, AVX2_I8);
    REGISTER_FASTPATH_VARIANTS(RGBA8ToAYUV8,        AVX2VNNI_I16, AVX2_I16);
    
    REGISTER_FASTPATH_VARIANTS(RGB8ToY410,          AVX2VNNI_I16, AVX2_I16); 
    REGISTER_FASTPATH_VARIANTS(RGBA8ToY410,         AVX2VNNI_I16, AVX2_I16);

    REGISTER_FASTPATH_VARIANTS(YCbCr8ToRGB8,        AVX2_I16_2, AVX2_I16);
    REGISTER_FASTPATH_VARIANTS(YCbCr8ToRGBA8,       AVX2_I16_2, AVX2_I16);
