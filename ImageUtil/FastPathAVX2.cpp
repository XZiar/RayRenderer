...
DEFINE_FASTPATH_PARTIAL(ColorConvertor, AVX2)
{
    ...
    REGISTER_FASTPATH_VARIANTS(RGB555ToRGBA8,   AVX2, AVX22, AVX23, SIMD128); // BMI2 is always slower
    REGISTER_FASTPATH_VARIANTS(BGR555ToRGBA8,   AVX2, AVX22, AVX23, SIMD128);
    REGISTER_FASTPATH_VARIANTS(RGB5551ToRGBA8,  AVX2, AVX22, AVX23, SIMD128); // BMI2 is always slower
    REGISTER_FASTPATH_VARIANTS(BGR5551ToRGBA8,  AVX2, AVX22, AVX23, SIMD128);

    REGISTER_FASTPATH_VARIANTS(RGB565ToRGB8,    AVX2, AVX22, SSE41);
    REGISTER_FASTPATH_VARIANTS(BGR565ToRGB8,    AVX2, AVX22, SSE41);
    REGISTER_FASTPATH_VARIANTS(RGB565ToRGBA8,   AVX2, AVX22, AVX23, SIMD128);
    REGISTER_FASTPATH_VARIANTS(BGR565ToRGBA8,   AVX2, AVX22, AVX23, SIMD128);
